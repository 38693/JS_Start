...
namespace IntroChangeVariableValues
{
    internal class Program
    {
        ...
        private void Run()
        {
            ...
            myFavoriteCity = "London"; //geef hier myFavoriteCity een waarde 
            myFavoriteNumber = 27; //geef hier myFavoriteNumber een waarde 
            ...
            myFavoriteCity = "Brazil"; //geef hier myFavoriteCity een waarde 
